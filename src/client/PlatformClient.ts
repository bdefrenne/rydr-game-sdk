...
export interface PlatformSession {
  ...
  /** Ask the shell to show/hide the in-game platform menu (the hamburger that opens
   *  Exit + hardware/settings/profile). Default is visible. */
...
export function connectToPlatform(options: ConnectOptions): Promise<PlatformSession> {
  ...
  return new Promise<PlatformSession>((resolve, reject) => {
    ...
    const session: PlatformSession = {
      ...
      setMenu: (visible) => post({ rydr: true, type: "rydr/ui.setMenu", visible }),
